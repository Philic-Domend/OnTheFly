...
def main(cfg: Config) -> None:
    ...
    with Timer("Loading rollouts"):
        ...
        pkl_path = "./all_rollouts_updated_step_labels.pkl"
    ...
    for seed in seeds:
        ...
        for epoch in pbar:
            ...
            if epoch % 10 == 0 or epoch == n_epochs - 1:
                logs_timestep = eval_model_and_log_plus_mlp(
                    cfg=cfg,
                    model=model,
